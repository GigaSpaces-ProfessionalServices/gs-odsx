...
def setupOrReloadService(spaceName,schedulerInterval,managerServer,dbLocation):
    ...
    args+= " "+scheduler_config+" "+str(scheduler_interval)+" "+scheduler_minute+" "+scheduler_hour
