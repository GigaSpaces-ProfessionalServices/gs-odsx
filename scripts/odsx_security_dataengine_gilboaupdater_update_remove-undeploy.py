...
from utils.odsx_db2feeder_utilities import getGilboaQueryStatusFromSqlLite, deleteGilboaEntryFromSqlLite, \
    getUsernameByHost, getPasswordByHost
...
def proceedForIndividualUndeployed(managerHost):
    ...
    try:
        ...
        if(response.status_code==200):
            ...
            deleteGilboaEntryFromSqlLite(spaceTobeUndeploy)
        else:
...
if __name__ == '__main__':
    ...
    verboseHandle.printConsoleWarning("Menu -> DataEngine  -> Gilboa -> Update -> Stop-UnDeploy")
    username = ""
    password = ""
