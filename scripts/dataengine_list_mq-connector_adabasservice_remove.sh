...
rm -rf install install.tar dbagigashare /home/dbsh/install /home/dbsh/install.tar /home/dbsh/setenv.sh $gigapath/bin/st*_adabasFeeder.sh $HOME/.config/systemd/user/odsxadabas.service $gigapath"/Adabas/*" $gigalogpath"/Adabas/*"
