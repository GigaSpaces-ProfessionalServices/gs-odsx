...
def myCheckArg(args=None):
    parser = argparse.ArgumentParser(description='Script to start Object Management Service')
...
def startService(args):
    ...
    confirmMsg = Fore.YELLOW + "Are you sure, you want to start Object Management service ? (Yes/No) [Yes]:" + Fore.RESET
...
if __name__ == '__main__':
    verboseHandle.printConsoleWarning("Menu -> Object -> ObjectManagement -> Service -> Enable")
    args = []
