...
def inputParam():
    ...
    if(len(str(inputChoice))==0):
        confirmAll = str(userInputWrapper(Fore.YELLOW+"Do you want to start all db2-feeders y/N [N]: "+Fore.RESET))
...
if __name__ == '__main__':
    logger.info("odsx_security_dev_dataengine_db2-feeder_start")
    verboseHandle.printConsoleWarning("Menu -> Security -> Dev -> DataEngine -> DB2-Feeder -> Start")
    username = ""
    password = ""
    try:
