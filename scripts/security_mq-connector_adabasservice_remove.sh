...
rm -rf install install.tar /home/dbsh/install /home/dbsh/install.tar /home/dbsh/setenv.sh /usr/local/bin/st*_adabasFeeder.sh /etc/systemd/system/odsxadabas.service $gigapath/Adabas/* $gigalogpath/Adabas/*
