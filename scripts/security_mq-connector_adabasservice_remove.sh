...
rm -rf install install.tar /home/dbsh/install /home/dbsh/install.tar /home/dbsh/setenv.sh /giga/bin/st*_adabasFeeder.sh $HOME/.config/systemd/user/odsxadabas.service $gigapath/Adabas/* $gigalogpath/Adabas/*
