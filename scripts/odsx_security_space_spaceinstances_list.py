...
def listSpaceFromHosts(managerNodes):
    ...
    try:
        ...
        verboseHandle.printConsoleError("Eror in odsx_security_space_spaceinstances_list.py : "+str(e))
        logger.error("Exception in odsx_security_space_spaceinstances_list.py"+str(e))
        handleException(e)
