...
def proceedForSpaceUpgrade(spaceStatusIP, spaceStatus):
    ...
    if spaceStatus == "OFF":
        ...
        #         return
        cmd = build_remote_bash_cmd(str(spaceStatusIP), user, 'scripts/servers_manager_upgrade_manual.sh', '-s ' + additionalParam)
        with Spinner():
            os.system(cmd)
            pass
...
if __name__ == '__main__':
    logger.info("Menu -> Servers - Space - upgrade - manual ")
