...
from utils.odsx_db2feeder_utilities import getMSSQLQueryStatusFromSqlLite, getPasswordByHost, getUsernameByHost
...
def inputParam():
    ...
    if(str(inputChoice)=='1'):
        inputNumberToStart = str(userInputWrapper(Fore.YELLOW+"Enter serial number to start mssql-feeder : "+Fore.RESET))
...
if __name__ == '__main__':
    ...
    verboseHandle.printConsoleWarning("Menu -> DataEngine  -> Gilboa -> Full load -> Start")
    username = ""
    password = ""
