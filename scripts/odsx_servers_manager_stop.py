...
if __name__ == '__main__':
    ...
    verboseHandle.printConsoleWarning("Servers -> Manager -> Stop")
    args = []
        ...
        if len(sys.argv) > 1 and sys.argv[1] != menuDrivenFlag:
            ...
            if(hostConfiguration=='1'):
                ...
                if(confirm=='yes' or confirm=='y'):
                    ...
                    if(menuDrivenFlag=='m'):
                        logger.info("menudriven")
                        os.system('python3 scripts/odsx_servers_manager_stop.py'+' '+menuDrivenFlag)
                ...
                if(confirm=='yes' or confirm=='y'):
                    ...
                    for host in hostsConfigArray:
                        logger.info("Stopping host :"+str(host))
                        verboseHandle.printConsoleInfo("Stopping Host :"+str(host))
                        args.append('--host')
                        args.append(host)
                        args.append('-u')
                        args.append(user)
