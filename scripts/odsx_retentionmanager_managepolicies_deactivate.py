...
def deactivatePolicy():
    ...
    confirmInput = str(input(Fore.YELLOW+"Are you sure want to deactivate this retention Policy ?  [Yes (y) / No (n)]: "+Fore.RESET))
...
if __name__ == '__main__':
    verboseHandle.printConsoleInfo("Status of Retention Manager service")
