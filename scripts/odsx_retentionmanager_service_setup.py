...
def setupService():
    ...
    while(len(schedulerConf) == 0 or (str(schedulerConf)!='1') and str(schedulerConf)!='2'):
        schedulerConf = str(input(schedulerConfInput))
    ...
    setupOrReloadService(spaceName,schedulerInterval,managerServer,dbLocation)
...
if __name__ == '__main__':
    verboseHandle.printConsoleInfo("Registering Retention Manager service")
    setupService()
