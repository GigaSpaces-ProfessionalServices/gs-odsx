    ...
    try:
        ...
        if(confirmRollingUpdate=='y'):
            ...
            while label == True:
                ...
                print(" Restarting Srno partitons are :   "+str(partitionIdList))
                loggerTiered.info(" Restarting Srno partitons are :  "+str(partitionIdList))
                ...
                print(" Partition Restarted:   "+str(partitionIdList))
                loggerTiered.info(" Partition Restarted :  "+str(partitionIdList))
                if(len(ll) == 0):
                    label = False
            end_time = time.time()
...
def listGSC(managerHost):
    ...
    try:
        ...
        #     typeOfRestart = str(userInputWrapper(Fore.YELLOW+"[1] For rolling update all \n[99] For Exit. \nEnter your choice : "+Fore.RESET))
        #     logger.info("typeOfRestart : "+str(typeOfRestart))
        #
        #     if(str(typeOfRestart)=='1'):
        inputParams()
        truncateInSqlLite()
