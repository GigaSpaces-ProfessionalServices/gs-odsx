...
rm -rf setenv.sh gs dbagigashare install install.tar $gigapath/giga* $gigaworkPath/* $gigapath/bin/start_gs*.sh $gigapath/bin/stop_gs*.sh $HOME/.config/systemd/user/gs*.service
