...
def exitAndDisplay(isMenuDriven):
    ...
    if(isMenuDriven=='m'):
        ...
        os.system('python3 scripts/odsx_servers_service_start.py'+' '+isMenuDriven)
    else:
        cliArgumentsStr=''
        for arg in cliArguments:
            cliArgumentsStr+=arg
            cliArgumentsStr+=' '
        os.system('python3 scripts/odsx_servers_service_start.py'+' '+cliArgumentsStr)
...
if __name__ == '__main__':
    logger.info("servers - service - start ")
