...
def exitAndDisplay(isMenuDriven):
    if(isMenuDriven=='m'):
        ...
        for arg in cliArguments:
            cliArgumentsStr+=arg
            cliArgumentsStr+=' '
        os.system('python3 scripts/odsx_streams_pauseonline.py'+' '+cliArgumentsStr)

if __name__ == '__main__':
    logger.info("odsx_servers_streams_pauseonline")
    verboseHandle.printConsoleWarning('Servers -> Streams -> Pause online')
    args = []
                        ...
                        if(streamResumeStream.serverip == arguments.host):
                            ...
                            if(arguments.dryrun==True):
                                ...
                                if(str(output).__contains__('True')):
                                    ...
                                    verboseHandle.printConsoleInfo('CR8_ctl.sh not found to execute pausestream')
                                quit()
