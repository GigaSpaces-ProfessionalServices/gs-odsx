...
def executeCommandForStop():
    ...
    try:
        ...
        if(len(nodes)>0):
            confirm = str(userInputWrapper(Fore.YELLOW+"Are you sure want to stop NB applicative servers ["+nodes+"] (y/n) [y]: "+Fore.RESET))
...
if __name__ == '__main__':
    ...
    verboseHandle.printConsoleInfo("Menu -> servers -> Northbound -> Applicative -> Stop ")
    try:
