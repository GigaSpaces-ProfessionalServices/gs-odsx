...
def createGSCInputParam(managerHost,spaceNode):
    ...
    zoneGSC = str(userInputWrapper(Fore.YELLOW+"Enter zone of GSC to create [adsCons] : "+Fore.RESET))
    ...
    dPipelineLocationSourceInput = str(userInputWrapper(Fore.YELLOW+"Enter -Dpipeline.config.location source ["+str(dPipelineSourceConfig)+"] : "+Fore.RESET))
    ...
    dPipelineLocationTargetInput = str(userInputWrapper(Fore.YELLOW+"Enter -Dpipeline.config.location target ["+str(dPipelineTargetConfig)+"] : "+Fore.RESET))
...
def proceedToDeployPUInputParam(managerHost):
    ...
    global resourceName
    resourceName = str(userInputWrapper(Fore.YELLOW+"Enter name of PU to deploy [adabasConsumer] :"+Fore.RESET))
    ...
    global zoneOfPU
    zoneOfPU = str(userInputWrapper(Fore.YELLOW+"Enter zone of processing unit to deploy [adsCons] :"+Fore.RESET))
    ...
    consumerGroup = str(userInputWrapper(Fore.YELLOW+"Enter spring.kafka.consumer-group [DIH] :"+Fore.RESET))
