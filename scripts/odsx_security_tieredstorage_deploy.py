...
def displaySummaryOfInputParam(confirmCreateGSC):
    try:
        ...
        verboseHandle.printConsoleWarning("Enter maxInstancesPerMachine :"+str(maxInstancesPerMachine))
        verboseHandle.printConsoleWarning("Enter maxInstancesPerVM :"+str('0'))
        verboseHandle.printConsoleWarning("SLA [HA] ? (y/n) :"+str(str(backUpRequiredStr)))
