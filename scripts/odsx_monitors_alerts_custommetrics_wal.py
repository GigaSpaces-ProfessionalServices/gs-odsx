...
def listWAL():
    ...
    installStatus='No'
    sourcePath= sourceInstallerDirectory+"/telegraf/scripts/agent"
    packageName=""
    dir_list=""
...
if __name__ == '__main__':
    verboseHandle.printConsoleWarning('Menu -> Monitors -> Alerts -> Custom metrics -> WAL')
    try:
        listWAL()
