...
def createGSCInputParam(managerNodes,spaceNodes,managerHostConfig):
    ...
    try:
        ...
        confirmCreateGSC = 'y'#str(readValuefromAppConfig("app.spacejar.creategsc"))#str(userInputWrapper(Fore.YELLOW+"Do you want to create GSC ? (y/n) [y] :"+Fore.RESET))
...
if __name__ == '__main__':
    ...
    try:
        ...
        verboseHandle.printConsoleError("Exception in odsx_space_createspace_jar.py "+str(e))
        handleException(e)