...
if __name__ == '__main__':
    logger.info("odsx_security_dev_dataengine_mssql-feeder_install")
    verboseHandle.printConsoleWarning('Menu ->Security -> Dev -> DataEngine -> MSSQL-Feeder -> Install-Deploy')
    username = ""
    password = ""
    try:
