...
def inputParam():
    ...
    if(len(str(inputChoice))==0):
        ...
        for i in range (1,elements+1):
            proceedToStopOracleFeeder(str(i))
...
def proceedToStopOracleFeeder(fileNumberToStop):
...
if __name__ == '__main__':
    logger.info("odsx_dataengine_oracle-feeder_stop")
    verboseHandle.printConsoleWarning("Menu -> DataEngine -> Oracle-Feeder -> Stop")
    try:
        managerHost=''
        ...
        verboseHandle.printConsoleError("Eror in odsx_oracle-feeder_stop : "+str(e))
        handleException(e)