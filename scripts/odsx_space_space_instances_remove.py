...
def instancelistFromHosts(managerNodes):
    ...
    try:
        ...
        verboseHandle.printConsoleError("Error in odsx_space_space_instances_remove.py : " + str(e))
        logger.error("Exception in odsx_space_space_instances_remove.py" + str(e))
        handleException(e)
    return instanceList
                ...
                if optionMainMenu != '99':
                    ...
                    if (confirm == 'yes' or confirm == 'y'):
                        ...
                        if (isMenuDriven == 'm'):
                            ...
                            os.system('python3 scripts/odsx_space_space_instances_remove.py' + ' ' + isMenuDriven)
