...
if __name__ == '__main__':
    logger.info("odsx_dataengine_Oracle-feeder_reset")
    verboseHandle.printConsoleWarning("Menu -> DataEngine -> Oracle-Feeder -> Reset")
    try:
        sqlLiteDeleteTableOracleFeeder()
    except Exception as e:
        verboseHandle.printConsoleError("Eror in odsx_oracle-feeder_reset : "+str(e))
        handleException(e)
