...
def inputParam():
    ...
    if(len(str(inputChoice))==0):
        confirmAll = str(userInputWrapper(Fore.YELLOW+"Do you want to start all oracle-Erp-feeders y/N [N]: "+Fore.RESET))
...
if __name__ == '__main__':
    ...
    verboseHandle.printConsoleWarning("Menu -> DataEngine -> Oracle-Feeder_ERP -> Start")
    username = ""
    password = ""
