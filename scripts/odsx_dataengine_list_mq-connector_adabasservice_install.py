...
def getInputParam(kafkaHosts):
    ...
    sourceAdabasJarFile = str(input(Fore.YELLOW+"Enter source adbas .jar file path including file name ["+str(sourceConfig)+"] : "+Fore.RESET))
...
if __name__ == '__main__':
    verboseHandle.printConsoleWarning('Menu -> DataEngine -> List -> MQ-Connector -> Install')
    try:
