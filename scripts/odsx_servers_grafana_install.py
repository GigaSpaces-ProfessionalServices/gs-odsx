...
def installUserAndTargetDirectory():
    ...
    try:
        ...
        verboseHandle.printConsoleInfo("3. dashboards source : "+str(gsConfigSpaceboardSource))
        verboseHandle.printConsoleInfo("4. dashboards target : "+str(gsConfigSpaceboardTarget))
